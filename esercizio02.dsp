...
frq1 = vslider("f [style:knob][unit:Hz]", 440,100,20000,1); 
...
vol1 = vslider("vol", 0.0,0.0,1.0,0.01);
vol2 = vslider("vol", 0.0,0.0,1.0,0.01);
vol3 = vslider("vol", 0.0,0.0,1.0,0.01);
vol4 = vslider("vol", 0.0,0.0,1.0,0.01);
